# Makefile for Duet 3 Expansion 1HCL (SAME51)
# This board uses SAME51G19A MCU with Cortex-M4F + FPU

# Board name
BOARD := EXP1HCL

# Output binary name
BINARY := Duet3Firmware_EXP1HCL
...
CXX_DEFINES := -D__SAME51G19A__ -D__ARM_ARCH_7EM__=1 -DEXP1HCL -DRTOS
...
# Linker script (using same as EXP3HC - adjust if needed)
...
# Common flags
COMMON_FLAGS := -c -mcpu=$(MCU_ARCH) -mthumb -fno-math-errno $(FPU_FLAGS) -mfp16-format=ieee \
