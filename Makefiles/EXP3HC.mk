# Makefile for Duet 3 Expansion 3HC (SAME51)
# This board uses SAME51N19A MCU with Cortex-M4F + FPU

# Board name
BOARD := EXP3HC

# Output binary name
BINARY := Duet3Firmware_EXP3HC
...
CXX_DEFINES := -D__SAME51N19A__ -D__ARM_ARCH_7EM__=1 -DEXP3HC -DRTOS
