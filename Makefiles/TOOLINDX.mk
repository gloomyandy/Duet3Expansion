...
C_DEFINES := -D__SAME51J19A__ -D__ARM_ARCH_7EM__=1 -Dnoexcept=

# C++ files get board-specific defines
CXX_DEFINES := -D__SAME51J19A__ -D__ARM_ARCH_7EM__=1 -DTOOLINDX -DRTOS
