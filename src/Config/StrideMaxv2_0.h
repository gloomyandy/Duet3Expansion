...
constexpr Pin TempSensePins[NumThermistorInputs] = { GpioPin(26), GpioPin(27), GpioPin(28)};
...
constexpr PinDescription PinTable[] =
{
	...
	{ PwmOutput::pwm4a,	AdcInput::none,		nullptr		},	// GPIO8 CAN SPI1 MISO
	{ PwmOutput::pwm4b,	AdcInput::none,		nullptr		},	// GPIO9 CAN SPI1 CS
	{ PwmOutput::pwm5a,	AdcInput::none,		nullptr		},	// GPIO10 CAN SPI1 CLK
	{ PwmOutput::pwm5b,	AdcInput::none,		nullptr		},	// GPIO11 CAN SPI1 MOSI
	{ PwmOutput::pwm6a,	AdcInput::none,		nullptr 	},	// GPIO12 CAN MCP INT
	{ PwmOutput::pwm6b,	AdcInput::none,		nullptr 	},	// GPIO13 MOT1 STEP
	{ PwmOutput::pwm7a,	AdcInput::none,		nullptr		},	// GPIO14 MOT1 DIAG
	{ PwmOutput::pwm7b,	AdcInput::none,		"io3.in,tach0"	},	// GPIO15 FAN0 TACH
	{ PwmOutput::pwm0a,	AdcInput::none,		"io0.in"	},	// GPIO16 IO IN 0
	{ PwmOutput::pwm0b,	AdcInput::none,		"io1.in"	},	// GPIO17 IO IN 1
	{ PwmOutput::pwm1a,	AdcInput::none,		"out1" 	    },	// GPIO18 FAN1
	{ PwmOutput::pwm1b,	AdcInput::none,		"rgbled"	},	// GPIO19 RGB
	...
	{ PwmOutput::none,	AdcInput::none,		"io4.in,tach1"	},	// GPIO25 FAN1 TACH
	...
	{ PwmOutput::none,	AdcInput::adc0_3,	nullptr 	},	// GPIO29 Power ADC
};
