 ...
 */
/* Board Revisons
	REV 0 Original picocan board
	REV 1 spican based board
*/
...
#if BOARD_REV == 1
constexpr Pin GlobalTmcEnablePin = GpioPin(13);
...
#else
constexpr Pin GlobalTmcEnablePin = GpioPin(25);
...
# else
constexpr unsigned int Temperature_SpiChannel = 1;
# endif
#endif
...
#else
constexpr unsigned int Lis_SpiChannel = 1;
