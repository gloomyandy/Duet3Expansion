...
#elif defined(SAMMYC21) || defined(RPI_PICO) || defined(FLY36RRF) || defined(FLYSB2040V1_0) || defined(PITBV1_0) || defined(STRIDEMAXV1_0) || defined(SHT36) || defined(MKSTHR3642)
...
#if defined(SAMMYC21) || HAS_USB_SERIAL
